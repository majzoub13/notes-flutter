...
class NotesService {
  ...
  Future<DatabaseNote> getNote({required int id}) async {
    ...
    if (notes.isEmpty) {
      ...
      final note = DatabaseNote.frontRow(notes.first);
  ...
  Future<DatabaseUser> getUser({required String email}) async {
    ...
    if (results.isEmpty) {
      ...
      return DatabaseUser.frontRow(results.first);
    }
  }
...
class DatabaseUser {
  ...
  DatabaseUser.frontRow(Map<String, Object?> map)
...
class DatabaseNote {
  ...
  DatabaseNote.frontRow(Map<String, Object?> map)
      : id = map[idColumn] as int,
